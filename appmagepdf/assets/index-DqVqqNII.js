import{n as e}from"./rolldown-runtime-S-ySWqyJ.js";import{n as t,t as n}from"./pdflib-qVFFl0zM.js";import{n as r,t as i}from"./pdfjs-ChQ4HP4S.js";(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var a={th:{"nav.merge":`รวมไฟล์ PDF`,"nav.delete":`ลบหน้า`,"nav.reorder":`จัดเรียงหน้า`,"nav.organize":`จัดระเบียบหน้า`,"nav.img2pdf":`แปลงรูปเป็น PDF`,"nav.compress":`บีบอัด PDF`,"nav.split":`แยกไฟล์ PDF`,"nav.rotate":`หมุนหน้า`,"nav.extract":`แยกหน้าที่เลือก`,"nav.home":`เครื่องมือจัดการ PDF`,"security.badge":`ประมวลผลในเครื่องเท่านั้น`,"security.desc":`ไฟล์ของคุณจะไม่ถูกส่งไปยังเซิร์ฟเวอร์ใดๆ ทุกขั้นตอนทำงานบนเบราว์เซอร์ของคุณโดยตรง มั่นใจได้ในความปลอดภัยของข้อมูล`,"dashboard.welcome":`ยินดีต้อนรับสู่ PDF Manager`,"dashboard.sub":`เลือกเครื่องมือที่คุณต้องการเพื่อจัดการไฟล์ PDF อย่างรวดเร็วและปลอดภัย`,"merge.title":`รวมไฟล์ PDF`,"merge.dropText":`ลากไฟล์ PDF มาวางที่นี่ หรือคลิกเพื่อเลือก`,"merge.dropHint":`รองรับหลายไฟล์พร้อมกัน`,"merge.files":`ไฟล์`,"merge.totalPages":`หน้ารวม`,"merge.clearAll":`ล้างทั้งหมด`,"merge.mergeBtn":`รวมไฟล์ PDF`,"merge.needTwo":`ต้องมีอย่างน้อย 2 ไฟล์เพื่อรวม`,"merge.processing":`กำลังรวมไฟล์ PDF...`,"merge.success":`รวมไฟล์สำเร็จ! ✓`,"merge.dragReorder":`ลากเพื่อจัดเรียง`,"merge.removeFile":`ลบไฟล์`,"merge.pages":`หน้า`,"merge.expandPages":`ดูหน้า`,"merge.collapsePages":`ซ่อนหน้า`,"merge.viewPage":`ดูหน้า`,"delete.title":`ลบหน้า`,"delete.dropText":`เลือกไฟล์ PDF ที่ต้องการลบหน้า`,"delete.dropHint":`ลากไฟล์มาวาง หรือคลิกเพื่อเลือก`,"delete.selectAll":`เลือกทั้งหมด`,"delete.deselectAll":`ยกเลิกทั้งหมด`,"delete.deleteBtn":`ลบหน้าที่เลือก`,"delete.selected":`เลือก`,"delete.of":`จาก`,"delete.pagesLabel":`หน้า`,"delete.minWarning":`(ต้องเหลืออย่างน้อย 1 หน้า)`,"delete.processing":`กำลังลบหน้า...`,"delete.success":`ลบ {n} หน้าสำเร็จ! ✓`,"delete.pageNum":`หน้า {n}`,"delete.viewPage":`ดูหน้า`,"delete.reorderHint":`ลากเพื่อจัดเรียง · คลิกเพื่อเลือก`,"reorder.title":`จัดเรียงหน้า`,"reorder.dropText":`เลือกไฟล์ PDF ที่ต้องการจัดเรียงหน้า`,"reorder.dropHint":`ลากเพื่อสลับตำแหน่งหน้า`,"reorder.info":`{n} หน้า — ลากเพื่อจัดเรียงลำดับ`,"reorder.reset":`รีเซ็ต`,"reorder.saveBtn":`บันทึก PDF`,"reorder.processing":`กำลังจัดเรียงหน้า...`,"reorder.success":`จัดเรียงหน้าสำเร็จ! ✓`,"reorder.pageNum":`หน้า {n}`,"reorder.viewPage":`ดูหน้า`,"split.title":`แยกไฟล์ PDF`,"split.dropText":`เลือกไฟล์ PDF ที่ต้องการแยก`,"split.dropHint":`แบ่ง PDF เป็นหลายไฟล์ตามช่วงหน้า`,"split.viewPage":`ดูหน้า`,"split.totalPages":`ทั้งหมด {n} หน้า`,"split.splitEvery":`แยกทุกหน้า (1 หน้า/ไฟล์)`,"split.rangeLabel":`กำหนดช่วงหน้า (1-indexed)`,"split.addRange":`เพิ่มช่วง`,"split.file":`ไฟล์`,"split.to":`ถึง`,"split.removeRange":`ลบช่วง`,"split.info":`จะแยกเป็น {n} ไฟล์`,"split.splitBtn":`แยกไฟล์ PDF`,"split.invalidRange":`ช่วงที่ {n} ไม่ถูกต้อง (1-{max})`,"split.processing":`กำลังแยกไฟล์ PDF...`,"split.success":`แยกเป็น {n} ไฟล์สำเร็จ! ✓`,"rotate.title":`หมุนหน้า`,"rotate.dropText":`เลือกไฟล์ PDF ที่ต้องการหมุนหน้า`,"rotate.dropHint":`คลิกที่หน้าเพื่อหมุน 90° ตามเข็มนาฬิกา`,"rotate.allRotate90":`หมุนทุกหน้า 90°`,"rotate.reset":`รีเซ็ต`,"rotate.saveBtn":`บันทึก PDF`,"rotate.info":`{n} หน้าถูกหมุน`,"rotate.noRotation":`ยังไม่ได้หมุนหน้าใด`,"rotate.processing":`กำลังหมุนหน้า...`,"rotate.success":`หมุน {n} หน้าสำเร็จ! ✓`,"rotate.pageNum":`หน้า {n}`,"rotate.viewPage":`ดูหน้า`,"extract.title":`แยกหน้าที่เลือก`,"extract.dropText":`เลือกไฟล์ PDF ที่ต้องการแยกหน้า`,"extract.dropHint":`เลือกเฉพาะหน้าที่ต้องการเป็นไฟล์ใหม่`,"extract.selectAll":`เลือกทั้งหมด`,"extract.deselectAll":`ยกเลิกทั้งหมด`,"extract.extractBtn":`แยกหน้าที่เลือก`,"extract.selected":`เลือก`,"extract.of":`จาก`,"extract.pagesLabel":`หน้า`,"extract.processing":`กำลังแยกหน้า...`,"extract.success":`แยก {n} หน้าสำเร็จ! ✓`,"extract.pageNum":`หน้า {n}`,"extract.viewPage":`ดูหน้า`,"img2pdf.title":`แปลงรูปเป็น PDF`,"img2pdf.dropText":`ลากรูปภาพมาวางที่นี่ (JPG, PNG)`,"img2pdf.dropHint":`สามารถเลือกหลายรูปและจัดเรียงได้ตามต้องการ`,"img2pdf.btn":`สร้างไฟล์ PDF จากรูป`,"compress.title":`บีบอัด PDF`,"compress.dropText":`เลือกไฟล์ PDF ที่ต้องการลดขนาด`,"compress.dropHint":`ลดขนาดไฟล์เพื่อให้ส่งทางอีเมลหรือแอปแชทได้ง่ายขึ้น`,"compress.btn":`บีบอัดไฟล์ PDF`,"compress.processing":`กำลังบีบอัดไฟล์ PDF...`,"compress.success":`บีบอัดสำเร็จ! ลดขนาดลงได้ {n}%`,"viewer.close":`ปิด`,"viewer.prev":`หน้าก่อน`,"viewer.next":`หน้าถัดไป`,"viewer.pageOf":`{current} / {total}`,"viewer.select":`เลือก`,"viewer.deselect":`ยกเลิกเลือก`,"viewer.rotate":`หมุน 90°`,"viewer.delete":`ลบหน้านี้`,"common.loading":`กำลังโหลด PDF...`,"common.readError":`ไม่สามารถอ่านไฟล์ PDF`,"common.error":`เกิดข้อผิดพลาด`,"common.selectPdf":`กรุณาเลือกไฟล์ PDF`,"common.viewPage":`ดูหน้า`,"common.deleteAll":`ไม่สามารถลบทุกหน้าได้ — ต้องเหลืออย่างน้อย 1 หน้า`},en:{"nav.merge":`Merge PDFs`,"nav.delete":`Delete Pages`,"nav.reorder":`Reorder Pages`,"nav.organize":`Organize PDF`,"nav.img2pdf":`Image to PDF`,"nav.compress":`Compress PDF`,"nav.split":`Split PDF`,"nav.rotate":`Rotate Pages`,"nav.extract":`Extract Pages`,"nav.home":`PDF Tools Dashboard`,"security.badge":`Processed locally only`,"security.desc":`Your files are never sent to any server. Everything is processed directly in your browser, ensuring maximum privacy and security.`,"dashboard.welcome":`Welcome to PDF Manager`,"dashboard.sub":`Choose a tool to manage your PDF files quickly and securely.`,"merge.title":`Merge PDFs`,"merge.dropText":`Drag PDF files here or click to select`,"merge.dropHint":`Supports multiple files`,"merge.files":`files`,"merge.totalPages":`total pages`,"merge.clearAll":`Clear all`,"merge.mergeBtn":`Merge PDFs`,"merge.needTwo":`Need at least 2 files to merge`,"merge.processing":`Merging PDFs...`,"merge.success":`Files merged successfully! ✓`,"merge.dragReorder":`Drag to reorder`,"merge.removeFile":`Remove file`,"merge.pages":`pages`,"merge.expandPages":`View pages`,"merge.collapsePages":`Hide pages`,"merge.viewPage":`View page`,"delete.title":`Delete Pages`,"delete.dropText":`Select a PDF to delete pages from`,"delete.dropHint":`Drag a file here or click to select`,"delete.selectAll":`Select all`,"delete.deselectAll":`Deselect all`,"delete.deleteBtn":`Delete selected`,"delete.selected":`Selected`,"delete.of":`of`,"delete.pagesLabel":`pages`,"delete.minWarning":`(Must keep at least 1 page)`,"delete.processing":`Deleting pages...`,"delete.success":`Deleted {n} pages! ✓`,"delete.pageNum":`Page {n}`,"delete.viewPage":`View page`,"delete.reorderHint":`Drag to reorder · Click to select`,"reorder.title":`Reorder Pages`,"reorder.dropText":`Select a PDF to reorder pages`,"reorder.dropHint":`Drag to swap page positions`,"reorder.info":`{n} pages — drag to reorder`,"reorder.reset":`Reset`,"reorder.saveBtn":`Save PDF`,"reorder.processing":`Reordering pages...`,"reorder.success":`Pages reordered! ✓`,"reorder.pageNum":`Page {n}`,"reorder.viewPage":`View page`,"split.title":`Split PDF`,"split.dropText":`Select a PDF to split`,"split.dropHint":`Split PDF into multiple files by page ranges`,"split.viewPage":`View page`,"split.totalPages":`Total {n} pages`,"split.splitEvery":`Split every page (1 page/file)`,"split.rangeLabel":`Define page ranges (1-indexed)`,"split.addRange":`Add range`,"split.file":`File`,"split.to":`to`,"split.removeRange":`Remove range`,"split.info":`Will split into {n} files`,"split.splitBtn":`Split PDF`,"split.invalidRange":`Range {n} is invalid (1-{max})`,"split.processing":`Splitting PDF...`,"split.success":`Split into {n} files! ✓`,"rotate.title":`Rotate Pages`,"rotate.dropText":`Select a PDF to rotate pages`,"rotate.dropHint":`Click a page to rotate 90° clockwise`,"rotate.allRotate90":`Rotate all 90°`,"rotate.reset":`Reset`,"rotate.saveBtn":`Save PDF`,"rotate.info":`{n} pages rotated`,"rotate.noRotation":`No pages rotated yet`,"rotate.processing":`Rotating pages...`,"rotate.success":`Rotated {n} pages! ✓`,"rotate.pageNum":`Page {n}`,"rotate.viewPage":`View page`,"extract.title":`Extract Pages`,"extract.dropText":`Select a PDF to extract pages from`,"extract.dropHint":`Pick specific pages for a new PDF`,"extract.selectAll":`Select all`,"extract.deselectAll":`Deselect all`,"extract.extractBtn":`Extract selected`,"extract.selected":`Selected`,"extract.of":`of`,"extract.pagesLabel":`pages`,"extract.processing":`Extracting pages...`,"extract.success":`Extracted {n} pages! ✓`,"extract.pageNum":`Page {n}`,"extract.viewPage":`View page`,"img2pdf.title":`Image to PDF`,"img2pdf.dropText":`Drag images here (JPG, PNG)`,"img2pdf.dropHint":`Supports multiple images and custom sorting`,"img2pdf.btn":`Convert to PDF`,"compress.title":`Compress PDF`,"compress.dropText":`Select a PDF to reduce its size`,"compress.dropHint":`Reduce file size for easier sharing via email or chat`,"compress.btn":`Compress PDF`,"compress.processing":`Compressing PDF...`,"compress.success":`Compressed successfully! Saved {n}%`,"viewer.close":`Close`,"viewer.prev":`Previous`,"viewer.next":`Next`,"viewer.pageOf":`{current} / {total}`,"viewer.select":`Select`,"viewer.deselect":`Deselect`,"viewer.rotate":`Rotate 90°`,"viewer.delete":`Delete this page`,"common.loading":`Loading PDF...`,"common.readError":`Cannot read PDF file`,"common.error":`Error occurred`,"common.selectPdf":`Please select a PDF file`,"common.viewPage":`View page`,"common.deleteAll":`Cannot delete all pages — at least 1 must remain`}},o=localStorage.getItem(`pdf-manager-lang`)||`th`,s=[];function c(e,t={}){let n=a[o]?.[e]||a.th[e]||e;for(let[e,r]of Object.entries(t))n=n.replace(`{${e}}`,r);return n}function ee(){return o}function te(e){e!==`th`&&e!==`en`||(o=e,localStorage.setItem(`pdf-manager-lang`,e),s.forEach(t=>t(e)))}function ne(){te(o===`th`?`en`:`th`)}function l(e){return s.push(e),()=>{s=s.filter(t=>t!==e)}}function u(e){return new Promise((t,n)=>{let r=new FileReader;r.onload=()=>t(r.result),r.onerror=n,r.readAsArrayBuffer(e)})}function re(e){if(e===0)return`0 B`;let t=1024,n=[`B`,`KB`,`MB`,`GB`],r=Math.floor(Math.log(e)/Math.log(t));return parseFloat((e/t**+r).toFixed(1))+` `+n[r]}async function d(e){return(await n.load(e)).getPageCount()}async function ie(e){let t=await n.create();for(let r of e){let e=await n.load(r);(await t.copyPages(e,e.getPageIndices())).forEach(e=>t.addPage(e))}return t.save()}async function ae(e,t){let r=await n.load(e),i=await n.create();return(await i.copyPages(r,t)).forEach(e=>i.addPage(e)),i.save()}async function oe(e,t){let r=await n.load(e),i=[];for(let e of t){let t=await n.create(),a=[];for(let t=e.start;t<=e.end;t++)a.push(t);(await t.copyPages(r,a)).forEach(e=>t.addPage(e)),i.push(await t.save())}return i}async function se(e,r){let i=await n.load(e);for(let[e,n]of r){let r=i.getPage(e),a=r.getRotation().angle;r.setRotation(t((a+n)%360))}return i.save()}async function ce(e,t){let r=await n.load(e),i=await n.create();return(await i.copyPages(r,t)).forEach(e=>i.addPage(e)),i.save()}function f(e,t){let n=new Blob([e],{type:`application/pdf`}),r=URL.createObjectURL(n),i=document.createElement(`a`);i.href=r,i.download=t,document.body.appendChild(i),i.click(),document.body.removeChild(i),URL.revokeObjectURL(r)}i.workerSrc=new URL(``+new URL(`pdf.worker-xSiVJ7U_.mjs`,import.meta.url).href,``+import.meta.url).toString();async function le(e){return r({data:new Uint8Array(e)}).promise}async function ue(e,t,n,r=200){let i=await e.getPage(t),a=r/i.getViewport({scale:1}).width,o=i.getViewport({scale:a});n.width=o.width,n.height=o.height;let s=n.getContext(`2d`);s.clearRect(0,0,n.width,n.height),s.fillStyle=`#fff`,s.fillRect(0,0,n.width,n.height),await i.render({canvasContext:s,viewport:o}).promise}function p(e,t=200){return new Promise(async(n,r)=>{try{let r=await le(e),i=Array.from({length:r.numPages},()=>{let e=document.createElement(`canvas`);return e.width=210,e.height=297,e});n(i),(async()=>{for(let e=1;e<=r.numPages;e+=5){let n=[];for(let a=e;a<e+5&&a<=r.numPages;a++)n.push(ue(r,a,i[a-1],t));await Promise.all(n),await new Promise(e=>setTimeout(e,0))}})()}catch(e){r(e)}})}var m=null,h=null;function g({pdfBuffer:e,pageIndex:t,totalPages:n,onClose:r,renderActions:i}){pe(),h={pdfBuffer:e,pageIndex:t,totalPages:n,onClose:r,renderActions:i,pdfDoc:null},m=document.createElement(`div`),m.className=`page-viewer-overlay`,m.innerHTML=`
  ...
  `,Me(e)}function Me(e){let t=e.querySelector(`#reorder-drop-zone`),n=e.querySelector(`#reorder-file-input`);t.addEventListener(`dragover`,e=>{e.preventDefault(),t.classList.add(`drag-over`)}),t.addEventListener(`dragleave`,()=>t.classList.remove(`drag-over`)),t.addEventListener(`drop`,n=>{n.preventDefault(),t.classList.remove(`drag-over`);let r=Array.from(n.dataTransfer.files).find(e=>e.type===`application/pdf`||e.name.endsWith(`.pdf`));r&&Ne(r,e)}),n.addEventListener(`change`,t=>{t.target.files[0]&&Ne(t.target.files[0],e),t.target.value=``}),e.querySelector(`#reorder-btn`)?.addEventListener(`click`,()=>Fe()),e.querySelector(`#reorder-reset`)?.addEventListener(`click`,()=>{O=O.map((e,t)=>t),k(e)})}async function Ne(e,t){Q(c(`common.loading`));try{D=new Uint8Array(await u(e)),ke=e.name;let n=await d(D);O=Array.from({length:n},(e,t)=>t),Ae=await p(D),t.querySelector(`#reorder-drop-zone`).style.display=`none`,t.querySelector(`#reorder-action-bar`).style.display=`flex`,await k(t)}catch(e){X(c(`common.readError`)+`: `+e.message,`error`)}finally{$()}}async function k(e){let t=e.querySelector(`#reorder-page-grid`),n=e.querySelector(`#reorder-info`);n.innerHTML=c(`reorder.info`,{n:`<strong>${O.length}</strong>`}),t.innerHTML=O.map((e,t)=>`
  ...
  `).join(``),O.forEach((e,n)=>{let r=t.querySelector(`#reorder-page-${n} .page-canvas-wrapper`),i=Ae[e];i&&(r.innerHTML=``,r.appendChild(i))}),Pe(t,e)}function Pe(e,t){e.querySelectorAll(`.view-btn`).forEach(e=>{e.addEventListener(`click`,t=>{t.stopPropagation();let n=parseInt(e.dataset.view),r=O[n];g({pdfBuffer:D,pageIndex:r,totalPages:O.length})})}),e.querySelectorAll(`[data-move-back]`).forEach(e=>{e.addEventListener(`click`,n=>{n.stopPropagation();let r=parseInt(e.dataset.moveBack);if(r>0){let[e]=O.splice(r,1);O.splice(r-1,0,e),k(t)}})}),e.querySelectorAll(`[data-move-fwd]`).forEach(e=>{e.addEventListener(`click`,n=>{n.stopPropagation();let r=parseInt(e.dataset.moveFwd);if(r<O.length-1){let[e]=O.splice(r,1);O.splice(r+1,0,e),k(t)}})}),typeof Sortable<`u`&&Sortable.create(e,{animation:200,ghostClass:`sortable-ghost`,dragClass:`sortable-drag`,forceFallback:!0,fallbackOnBody:!0,swapThreshold:.6,invertSwap:!0,onEnd:e=>{let{oldIndex:n,newIndex:r}=e;if(n===r)return;let[i]=O.splice(n,1);O.splice(r,0,i),k(t)}})}async function Fe(){Q(c(`reorder.processing`));try{f(await ae(D,O),ke.replace(`.pdf`,`_reordered.pdf`)),X(c(`reorder.success`),`success`)}catch(e){X(c(`common.error`)+`: `+e.message,`error`)}finally{$()}}var Ie=e({render:()=>Re}),A=null,Le=``,j=0,M=[{start:1,end:1}];function Re(e){A=null,Le=``,j=0,M=[{start:1,end:1}],e.innerHTML=`
  ...
  `,ze(e)}function ze(e){let t=e.querySelector(`#split-drop-zone`),n=e.querySelector(`#split-file-input`);t.addEventListener(`dragover`,e=>{e.preventDefault(),t.classList.add(`drag-over`)}),t.addEventListener(`dragleave`,()=>t.classList.remove(`drag-over`)),t.addEventListener(`drop`,n=>{n.preventDefault(),t.classList.remove(`drag-over`);let r=Array.from(n.dataTransfer.files).find(e=>e.type===`application/pdf`||e.name.endsWith(`.pdf`));r&&Be(r,e)}),n.addEventListener(`change`,t=>{t.target.files[0]&&Be(t.target.files[0],e),t.target.value=``})}async function Be(e,t){Q(c(`common.loading`));try{A=new Uint8Array(await u(e)),Le=e.name,j=await d(A),M=[{start:1,end:j}],t.querySelector(`#split-drop-zone`).style.display=`none`,await Ve(t),He(t)}catch(e){X(c(`common.readError`)+`: `+e.message,`error`)}finally{$()}}async function Ve(e){let t=e.querySelector(`#split-page-grid`),n=await p(A);t.innerHTML=n.map((e,t)=>`
  ...
  `).join(``),n.forEach((e,n)=>{t.querySelector(`#split-page-${n} .page-canvas-wrapper`).appendChild(e)}),t.querySelectorAll(`.view-btn`).forEach(e=>{e.addEventListener(`click`,t=>{t.stopPropagation();let n=parseInt(e.dataset.view);g({pdfBuffer:A,pageIndex:n,totalPages:j})})})}function He(e){let t=e.querySelector(`#split-config-area`);t.innerHTML=`
    <div class="split-config">
      <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:20px;">
        <div>
          <h3 style="font-size:1.05rem;font-weight:600;">${Le}</h3>
          <p style="color:var(--text-muted);font-size:0.85rem;margin-top:4px;">${c(`split.totalPages`,{n:j})}</p>
        </div>
  ...
  `,Ue(t),t.querySelector(`#split-add-range`).addEventListener(`click`,()=>{M.push({start:1,end:j}),Ue(t)}),t.querySelector(`#split-even-btn`).addEventListener(`click`,()=>{M=[];for(let e=1;e<=j;e++)M.push({start:e,end:e});Ue(t)}),t.querySelector(`#split-btn`).addEventListener(`click`,()=>Ge()),We(t)}function Ue(e){let t=e.querySelector(`#split-ranges`);t.innerHTML=M.map((e,t)=>`
    <div class="range-row">
      <span>${c(`split.file`)} ${t+1}:</span>
      <input type="number" min="1" max="${j}" value="${e.start}" data-range="${t}" data-field="start" />
      <span>${c(`split.to`)}</span>
      <input type="number" min="1" max="${j}" value="${e.end}" data-range="${t}" data-field="end" />
      ${M.length>1?`<button class="btn-icon danger" data-remove-range="${t}" title="${c(`split.removeRange`)}"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M18 6L6 18M6 6l12 12"/></svg></button>`:``}
    </div>
  `).join(``),t.querySelectorAll(`input`).forEach(t=>{t.addEventListener(`change`,()=>{let n=parseInt(t.dataset.range);M[n][t.dataset.field]=parseInt(t.value)||1,We(e)})}),t.querySelectorAll(`[data-remove-range]`).forEach(t=>{t.addEventListener(`click`,()=>{M.splice(parseInt(t.dataset.removeRange),1),Ue(e)})}),We(e)}function We(e){let t=e.querySelector(`#split-info`);t.innerHTML=c(`split.info`,{n:`<strong>${M.length}</strong>`})}async function Ge(){for(let e=0;e<M.length;e++){let t=M[e];if(t.start<1||t.end>j||t.start>t.end){X(c(`split.invalidRange`,{n:e+1,max:j}),`error`);return}}Q(c(`split.processing`));try{let e=M.map(e=>({start:e.start-1,end:e.end-1})),t=await oe(A,e);t.forEach((e,t)=>{f(e,`${Le.replace(`.pdf`,``)}_part${t+1}.pdf`)}),X(c(`split.success`,{n:t.length}),`success`)}catch(e){X(c(`common.error`)+`: `+e.message,`error`)}finally{$()}}var Ke=e({render:()=>Je}),N=null,qe=``,P=0,F=new Map;function Je(e){N=null,qe=``,P=0,F=new Map,e.innerHTML=`
  ...
  `,Ye(e)}function Ye(e){let t=e.querySelector(`#rotate-drop-zone`),n=e.querySelector(`#rotate-file-input`);t.addEventListener(`dragover`,e=>{e.preventDefault(),t.classList.add(`drag-over`)}),t.addEventListener(`dragleave`,()=>t.classList.remove(`drag-over`)),t.addEventListener(`drop`,n=>{n.preventDefault(),t.classList.remove(`drag-over`);let r=Array.from(n.dataTransfer.files).find(e=>e.type===`application/pdf`||e.name.endsWith(`.pdf`));r&&Xe(r,e)}),n.addEventListener(`change`,t=>{t.target.files[0]&&Xe(t.target.files[0],e),t.target.value=``}),e.querySelector(`#rotate-btn`)?.addEventListener(`click`,()=>Qe()),e.querySelector(`#rotate-all-90`)?.addEventListener(`click`,()=>{for(let e=0;e<P;e++)F.set(e,((F.get(e)||0)+90)%360);I(e)}),e.querySelector(`#rotate-reset`)?.addEventListener(`click`,()=>{F.clear(),I(e)})}async function Xe(e,t){Q(c(`common.loading`));try{N=new Uint8Array(await u(e)),qe=e.name,P=await d(N),F.clear(),t.querySelector(`#rotate-drop-zone`).style.display=`none`,t.querySelector(`#rotate-action-bar`).style.display=`flex`,await Ze(t),I(t)}catch(e){X(c(`common.readError`)+`: `+e.message,`error`)}finally{$()}}async function Ze(e){let t=e.querySelector(`#rotate-page-grid`),n=await p(N);t.innerHTML=n.map((e,t)=>`
  ...
  `).join(``),n.forEach((e,n)=>{t.querySelector(`#rotate-page-${n} .page-canvas-wrapper`).appendChild(e)}),t.querySelectorAll(`.page-card`).forEach(t=>{t.addEventListener(`click`,n=>{if(n.target.closest(`.view-btn`))return;let r=parseInt(t.dataset.page);F.set(r,((F.get(r)||0)+90)%360),I(e)})}),t.querySelectorAll(`.view-btn`).forEach(t=>{t.addEventListener(`click`,n=>{n.stopPropagation();let r=parseInt(t.dataset.view);g({pdfBuffer:N,pageIndex:r,totalPages:P,renderActions:(t,n)=>{let r=document.createElement(`button`);r.className=`btn btn-ghost`,r.innerHTML=`<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M1 4v6h6"/><path d="M3.51 15a9 9 0 1 0 2.13-9.36L1 10"/></svg> ${c(`viewer.rotate`)}`,r.addEventListener(`click`,()=>{F.set(t,((F.get(t)||0)+90)%360),I(e)}),n.appendChild(r)}})})})}function I(e){let t=e.querySelector(`#rotate-page-grid`),n=e.querySelector(`#rotate-info`);n.innerHTML=`<strong>${Array.from(F.values()).filter(e=>e!==0).length}</strong> ${c(`rotate.info`,{n:``}).trim()}`,t.querySelectorAll(`.page-card`).forEach(e=>{let t=parseInt(e.dataset.page),n=F.get(t)||0;e.querySelector(`.page-canvas-wrapper`).style.transform=`rotate(${n}deg)`;let r=e.querySelector(`.rotate-badge`);n===0?(r&&r.remove(),e.classList.remove(`selected`)):(r||(r=document.createElement(`div`),r.className=`rotate-badge`,e.appendChild(r)),r.textContent=`${n}°`,e.classList.add(`selected`))})}async function Qe(){let e=new Map;if(F.forEach((t,n)=>{t!==0&&e.set(n,t)}),e.size===0){X(c(`rotate.noRotation`),`info`);return}Q(c(`rotate.processing`));try{f(await se(N,e),qe.replace(`.pdf`,`_rotated.pdf`)),X(c(`rotate.success`,{n:e.size}),`success`)}catch(e){X(c(`common.error`)+`: `+e.message,`error`)}finally{$()}}var $e=e({render:()=>tt}),L=null,et=``,R=0,z=new Set;function tt(e){L=null,et=``,R=0,z=new Set,e.innerHTML=`
  ...
  `,nt(e)}function nt(e){let t=e.querySelector(`#extract-drop-zone`),n=e.querySelector(`#extract-file-input`);t.addEventListener(`dragover`,e=>{e.preventDefault(),t.classList.add(`drag-over`)}),t.addEventListener(`dragleave`,()=>t.classList.remove(`drag-over`)),t.addEventListener(`drop`,n=>{n.preventDefault(),t.classList.remove(`drag-over`);let r=Array.from(n.dataTransfer.files).find(e=>e.type===`application/pdf`||e.name.endsWith(`.pdf`));r&&rt(r,e)}),n.addEventListener(`change`,t=>{t.target.files[0]&&rt(t.target.files[0],e),t.target.value=``}),e.querySelector(`#extract-btn`)?.addEventListener(`click`,()=>at()),e.querySelector(`#extract-select-all`)?.addEventListener(`click`,()=>{for(let e=0;e<R;e++)z.add(e);B(e)}),e.querySelector(`#extract-deselect-all`)?.addEventListener(`click`,()=>{z.clear(),B(e)})}async function rt(e,t){Q(c(`common.loading`));try{L=new Uint8Array(await u(e)),et=e.name,R=await d(L),z.clear(),t.querySelector(`#extract-drop-zone`).style.display=`none`,t.querySelector(`#extract-action-bar`).style.display=`flex`,await it(t),B(t)}catch(e){X(c(`common.readError`)+`: `+e.message,`error`)}finally{$()}}async function it(e){let t=e.querySelector(`#extract-page-grid`),n=await p(L);t.innerHTML=n.map((e,t)=>`
  ...
  `,e.querySelectorAll(`.tool-card`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.feature;window.dispatchEvent(new CustomEvent(`load-feature`,{detail:t}))})})}var ut=e({render:()=>pt}),V=null,dt=``,H=0,U=[],ft=[];function pt(e){V=null,dt=``,H=0,U=[],e.innerHTML=`
  ...
  `,mt(e)}function mt(e){let t=e.querySelector(`#org-drop-zone`),n=e.querySelector(`#org-file-input`);t.addEventListener(`dragover`,e=>{e.preventDefault(),t.classList.add(`drag-over`)}),t.addEventListener(`dragleave`,()=>t.classList.remove(`drag-over`)),t.addEventListener(`drop`,n=>{n.preventDefault(),t.classList.remove(`drag-over`);let r=Array.from(n.dataTransfer.files).find(e=>e.type===`application/pdf`||e.name.endsWith(`.pdf`));r&&gt(r,e)}),n.addEventListener(`change`,t=>{t.target.files[0]&&gt(t.target.files[0],e),t.target.value=``}),e.querySelector(`#org-btn`)?.addEventListener(`click`,()=>vt()),e.querySelector(`#org-reset`)?.addEventListener(`click`,()=>{ht(),G(e),W(e)})}function ht(){U=[];for(let e=0;e<H;e++)U.push({originalIndex:e,rotation:0,isDeleted:!1})}async function gt(e,t){Q(c(`common.loading`));try{V=new Uint8Array(await u(e)),dt=e.name,H=await d(V),ft=await p(V),ht(),t.querySelector(`#org-drop-zone`).style.display=`none`,t.querySelector(`#org-action-bar`).style.display=`flex`,await W(t),G(t)}catch(e){X(c(`common.readError`)+`: `+e.message,`error`)}finally{$()}}async function W(e){let t=e.querySelector(`#org-page-grid`);t.innerHTML=U.map((e,t)=>`
    <div class="page-card org-card" data-index="${t}" id="org-page-${t}" draggable="true">
      ...
      <div class="page-move-actions">
        ...
        <button class="btn-move" data-move-fwd="${t}" ${t===U.length-1?`disabled`:``}>
          <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M9 18l6-6-6-6"/></svg>
        </button>
      </div>
    </div>
  `).join(``),U.forEach((e,n)=>{let r=t.querySelector(`#org-page-${n}`).querySelector(`.page-canvas-wrapper`),i=ft[e.originalIndex];i&&(r.innerHTML=``,r.appendChild(i)),e.rotation!==0&&(r.style.transform=`rotate(${e.rotation}deg)`)}),_t(t,e)}function _t(e,t){typeof Sortable<`u`&&Sortable.create(e,{animation:200,ghostClass:`sortable-ghost`,dragClass:`sortable-drag`,forceFallback:!0,fallbackOnBody:!0,swapThreshold:.6,invertSwap:!0,onEnd:e=>{let{oldIndex:n,newIndex:r}=e;if(n===r)return;let[i]=U.splice(n,1);U.splice(r,0,i),W(t),G(t)}}),e.querySelectorAll(`.org-card`).forEach(e=>{e.querySelector(`.rotate-btn`).addEventListener(`click`,n=>{n.stopPropagation();let r=parseInt(e.dataset.index);U[r].rotation=(U[r].rotation+90)%360,W(t),G(t)}),e.querySelector(`.delete-btn`).addEventListener(`click`,n=>{n.stopPropagation();let r=parseInt(e.dataset.index);if(U.filter(e=>!e.isDeleted).length<=1&&!U[r].isDeleted){X(c(`common.deleteAll`),`error`);return}U[r].isDeleted=!U[r].isDeleted,e.classList.toggle(`is-deleted`,U[r].isDeleted),G(t)}),e.querySelector(`.view-btn`).addEventListener(`click`,t=>{t.stopPropagation();let n=parseInt(e.dataset.index);g({pdfBuffer:V,pageIndex:U[n].originalIndex,totalPages:H})}),e.querySelector(`[data-move-back]`)?.addEventListener(`click`,n=>{n.stopPropagation();let r=parseInt(e.dataset.index);if(r>0){let[e]=U.splice(r,1);U.splice(r-1,0,e),W(t),G(t)}}),e.querySelector(`[data-move-fwd]`)?.addEventListener(`click`,n=>{n.stopPropagation();let r=parseInt(e.dataset.index);if(r<U.length-1){let[e]=U.splice(r,1);U.splice(r+1,0,e),W(t),G(t)}})})}function G(e){let t=e.querySelector(`#org-info`);t.innerHTML=`<strong>${U.filter(e=>!e.isDeleted).length}</strong> ${c(`delete.pagesLabel`)} · ${c(`reorder.dragReorder`)}`,e.querySelectorAll(`.org-card`).forEach(e=>{let t=parseInt(e.dataset.index);e.style.opacity=U[t].isDeleted?`0.3`:`1`,e.style.filter=U[t].isDeleted?`grayscale(1)`:`none`})}async function vt(){let e=U.filter(e=>!e.isDeleted);if(e.length!==0){Q(c(`reorder.processing`));try{let t=e.map(e=>e.originalIndex),n=await ae(V,t),r=new Map;e.forEach((e,t)=>{e.rotation!==0&&r.set(t,e.rotation)}),r.size>0&&(n=await se(n,r)),f(n,dt.replace(`.pdf`,`_organized.pdf`)),X(c(`reorder.success`),`success`)}catch(e){X(c(`common.error`)+`: `+e.message,`error`)}finally{$()}}}var yt=e({render:()=>bt}),K=[];function bt(e){K=[],e.innerHTML=`
  ...
  `,xt(e)}function xt(e){let t=e.querySelector(`#img-drop-zone`),n=e.querySelector(`#img-file-input`);t.addEventListener(`dragover`,e=>{e.preventDefault(),t.classList.add(`drag-over`)}),t.addEventListener(`dragleave`,()=>t.classList.remove(`drag-over`)),t.addEventListener(`drop`,n=>{n.preventDefault(),t.classList.remove(`drag-over`),St(n.dataTransfer.files,e)}),n.addEventListener(`change`,t=>{St(t.target.files,e),t.target.value=``}),e.querySelector(`#img-btn`)?.addEventListener(`click`,()=>Tt()),e.querySelector(`#img-clear-btn`)?.addEventListener(`click`,()=>{K=[],q(e)})}async function St(e,t){let n=Array.from(e).filter(e=>e.type.startsWith(`image/`));if(n.length!==0){for(let e of n){let t=await Ct(e);K.push({name:e.name,size:e.size,type:e.type,dataUrl:t})}q(t)}}function Ct(e){return new Promise(t=>{let n=new FileReader;n.onload=()=>t(n.result),n.readAsDataURL(e)})}function q(e){let t=e.querySelector(`#img-grid`),n=e.querySelector(`#img-action-bar`),r=e.querySelector(`#img-info`);if(K.length===0){t.innerHTML=``,n.style.display=`none`;return}n.style.display=`flex`,r.innerHTML=`<strong>${K.length}</strong> ${c(`merge.files`)} · ${c(`reorder.dragReorder`)}`,t.innerHTML=K.map((e,t)=>`
  ...
  `).join(``),t.querySelectorAll(`[data-remove]`).forEach(t=>{t.addEventListener(`click`,n=>{n.stopPropagation(),K.splice(parseInt(t.dataset.remove),1),q(e)})}),t.querySelectorAll(`[data-move-back]`).forEach(t=>{t.addEventListener(`click`,n=>{n.stopPropagation();let r=parseInt(t.dataset.moveBack);if(r>0){let[t]=K.splice(r,1);K.splice(r-1,0,t),q(e)}})}),t.querySelectorAll(`[data-move-fwd]`).forEach(t=>{t.addEventListener(`click`,n=>{n.stopPropagation();let r=parseInt(t.dataset.moveFwd);if(r<K.length-1){let[t]=K.splice(r,1);K.splice(r+1,0,t),q(e)}})}),wt(t,e)}function wt(e,t){typeof Sortable<`u`&&Sortable.create(e,{animation:200,ghostClass:`sortable-ghost`,dragClass:`sortable-drag`,forceFallback:!0,fallbackOnBody:!0,swapThreshold:.65,onEnd:e=>{let{oldIndex:n,newIndex:r}=e;if(n===r)return;let[i]=K.splice(n,1);K.splice(r,0,i),q(t)}})}async function Tt(){if(K.length!==0){Q(c(`common.loading`));try{let e=await n.create();for(let t of K){let n=await fetch(t.dataUrl).then(e=>e.arrayBuffer()),r;if(t.type===`image/jpeg`)r=await e.embedJpg(n);else if(t.type===`image/png`)r=await e.embedPng(n);else continue;e.addPage([r.width,r.height]).drawImage(r,{x:0,y:0,width:r.width,height:r.height})}f(await e.save(),`images_to_pdf.pdf`),X(c(`merge.success`),`success`)}catch(e){X(c(`common.error`)+`: `+e.message,`error`)}finally{$()}}}var Et=e({render:()=>kt}),Dt=null,Ot=``,J=0;function kt(e){Dt=null,e.innerHTML=`
  ...
  `,At(e)}function At(e){let t=e.querySelector(`#comp-drop-zone`),n=e.querySelector(`#comp-file-input`);t.addEventListener(`dragover`,e=>{e.preventDefault(),t.classList.add(`drag-over`)}),t.addEventListener(`dragleave`,()=>t.classList.remove(`drag-over`)),t.addEventListener(`drop`,n=>{n.preventDefault(),t.classList.remove(`drag-over`),n.dataTransfer.files[0]&&jt(n.dataTransfer.files[0],e)}),n.addEventListener(`change`,t=>{t.target.files[0]&&jt(t.target.files[0],e)}),e.querySelector(`#comp-btn`)?.addEventListener(`click`,()=>Mt())}async function jt(e,t){Dt=new Uint8Array(await u(e)),Ot=e.name,J=e.size,t.querySelector(`#comp-drop-zone`).style.display=`none`,t.querySelector(`#comp-result`).style.display=`block`,t.querySelector(`#comp-file-name`).textContent=Ot,t.querySelector(`#comp-file-meta`).textContent=re(J)}async function Mt(){Q(c(`compress.processing`));try{let e=await(await n.load(Dt)).save({useObjectStreams:!0,addDefaultPage:!1}),t=e.length,r=((J-t)/J*100).toFixed(1);f(e,Ot.replace(`.pdf`,`_compressed.pdf`)),X(c(`compress.success`,{n:r>0?r:0}),`success`)}catch(e){X(c(`common.error`)+`: `+e.message,`error`)}finally{$()}}var Nt={home:{module:ot,titleKey:`nav.home`},organize:{module:ut,titleKey:`nav.organize`},img2pdf:{module:yt,titleKey:`nav.img2pdf`},compress:{module:Et,titleKey:`nav.compress`},merge:{module:me,titleKey:`nav.merge`},delete:{module:xe,titleKey:`nav.delete`},reorder:{module:Oe,titleKey:`nav.reorder`},split:{module:Ie,titleKey:`nav.split`},rotate:{module:Ke,titleKey:`nav.rotate`},extract:{module:$e,titleKey:`nav.extract`}},Pt=`home`;document.addEventListener(`DOMContentLoaded`,()=>{Rt(),Bt(),It(),Ft(),zt(`home`),window.addEventListener(`load-feature`,e=>{zt(e.detail)}),l(()=>{Ft(),zt(Pt)})});function Ft(){for(let[e,t]of Object.entries({"nav-home":`nav.home`,"nav-organize":`nav.organize`,"nav-img2pdf":`nav.img2pdf`,"nav-compress":`nav.compress`,"nav-merge":`nav.merge`,"nav-delete":`nav.delete`,"nav-reorder":`nav.reorder`,"nav-split":`nav.split`,"nav-rotate":`nav.rotate`,"nav-extract":`nav.extract`})){let n=document.getElementById(e);if(n){let e=n.querySelector(`span`);e&&(e.textContent=c(t))}}let e=document.getElementById(`security-badge`);if(e){let t=e.querySelector(`span`);t&&(t.textContent=c(`security.badge`))}Lt()}function It(){let e=document.getElementById(`top-bar-actions`),t=document.createElement(`button`);t.className=`lang-toggle`,t.id=`lang-toggle-btn`,t.addEventListener(`click`,e=>{e.stopPropagation(),ne()}),e.appendChild(t),Lt()}function Lt(){let e=document.getElementById(`lang-toggle-btn`);e&&(e.innerHTML=ee()===`th`?`<span class="active-lang">TH</span> / <span>EN</span>`:`<span>TH</span> / <span class="active-lang">EN</span>`)}function Rt(){document.getElementById(`sidebar-nav`).querySelectorAll(`.nav-btn`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.feature;t&&t!==Pt&&zt(t)})})}function zt(e){Pt=e;let t=Nt[e];if(!t)return;document.querySelectorAll(`.nav-btn`).forEach(t=>{t.classList.toggle(`active`,t.dataset.feature===e)}),document.getElementById(`page-title`).textContent=c(t.titleKey);let n=document.getElementById(`content-area`);n.innerHTML=``,t.module.render(n),document.getElementById(`sidebar`).classList.remove(`open`)}function Bt(){let e=document.getElementById(`menu-toggle`),t=document.getElementById(`sidebar`);e.addEventListener(`click`,()=>{t.classList.toggle(`open`)}),document.addEventListener(`click`,n=>{window.innerWidth<=768&&t.classList.contains(`open`)&&!t.contains(n.target)&&!e.contains(n.target)&&t.classList.remove(`open`)})}var Y=null;function X(e,t=`info`){Y||(Y=document.createElement(`div`),Y.className=`toast-container`,document.body.appendChild(Y));let n={success:`<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 6L9 17l-5-5"/></svg>`,error:`<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M15 9l-6 6M9 9l6 6"/></svg>`,info:`<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M12 16v-4M12 8h.01"/></svg>`},r=document.createElement(`div`);r.className=`toast ${t}`,r.innerHTML=`${n[t]||n.info}<span>${e}</span>`,Y.appendChild(r),setTimeout(()=>{r.style.opacity=`0`,r.style.transform=`translateX(40px)`,r.style.transition=`all 0.3s ease`,setTimeout(()=>r.remove(),300)},4e3)}var Z=null;function Q(e=`Processing...`){Z||(Z=document.createElement(`div`),Z.className=`loading-overlay`,Z.innerHTML=`
